...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="recipeID" DataSourceID="sql_recipedetails" DefaultMode="Insert" Height="50px" Width="322px">
            <Fields>
